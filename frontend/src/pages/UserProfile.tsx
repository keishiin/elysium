    ...
    <>
      ...
      <div className="h-screen bg-black flex flex-col items-center">
        <div className="max-w-[610px] w-full">
          <Card className="text-white rounded border-2 border-red-600 bg-gray-500 dark:bg-default-100/50">
            <CardBody>
              <div className="grid grid-cols-6 md:grid-cols-12 gap-6 md:gap-4 items-center justify-center">
                <div className="relative col-span-6 md:col-span-4">
                  <Image
                    alt="player avatar"
                    className="object-cover opacity-100 rounded"
                    height={200}
                    shadow="md"
                ...
                <div className="flex flex-col col-span-6 md:col-span-8">
                  <div className="flex justify-between items-start">
                    <div className="flex flex-col gap-0">
                      ...
                      <p className="text-small text-foreground/80">
                          <button className="rounded outline outline-offset-2 outline-blue-500">Update Info</button>
                      </p>
                    </div>
                  </div>
                </div>
